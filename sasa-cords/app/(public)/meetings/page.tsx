    ...
    <div className="overflow-hidden">
      ...
      <section className="relative h-56 flex items-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto w-full px-4 sm:px-6 lg:px-8 pb-10">
          <p className="text-amber-300 text-xs font-semibold tracking-[0.2em] uppercase mb-2">Join Us</p>
          <h1 className="font-serif text-4xl sm:text-5xl text-white">Meetings</h1>
        </div>
      </section>
